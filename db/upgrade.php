...
/**
 * This file keeps track of upgrades to the infosysselfesteem module
 *
...
/**
 * Execute infosysselfesteem upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_infosysselfesteem_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the infosysselfesteem
     * iself has been upgraded.
     *
     * For each upgrade block, the file infosysselfesteem/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        // Define field intro to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        // Define field introformat to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'infosysselfesteem');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        // Define field timemodified to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        // Define index course (not unique) to be added to infosysselfesteem.
        $table = new xmldb_table('infosysselfesteem');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'infosysselfesteem');
    }
