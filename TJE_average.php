...
function tje_average($records){
    ...
    $judge_sum = array((int)$records->rubric_1, (int)$records->rubric_3, (int)$records->rubric_4, (int)$records->rubric_8);
    $expre_sum = array((int)$records->rubric_4, (int)$records->rubric_5, (int)$records->rubric_9, (int)$records->rubric_10, (int)$records->rubric_11);
