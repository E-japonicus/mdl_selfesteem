...
$string['infosysselfesteem:view'] = 'View self esteem';
$string['infosysselfesteemfieldset'] = 'Custom example fieldset';
$string['infosysselfesteemname'] = '自己評価タイトル';
$string['infosysselfesteemname_help'] = '入力したテキストはコースへ追加した際に表示されます。<br />例) 第x回自己評価';
$string['infosysselfesteem'] = 'self esteem';
$string['pluginadministration'] = 'self esteem administration';
...
$string['rubric[2]_suffix'] = '出題できそうな単元や内容についてそれぞれの関係性を';
...
$string['rubric[4]_score0'] = '良問として<span class="highlight">グループの代表に選ばれなかった</span>';
$string['rubric[4]_score1'] = '良問としてグループの代表に選ばれ、<span class="highlight">半分程度</span>の基準を満たした問題を作成できた';
$string['rubric[4]_score2'] = '良問としてグループの代表に選ばれ、<span class="highlight">8割程度</span>の基準を満たした問題を作成できた';
$string['rubric[4]_score3'] = '良問としてグループの代表に選ばれ、<span class="highlight">すべての基準</span>を満たした問題を作成できた';
...
$string['rubric[8]_score0'] = '今回の出題範囲の中で、何が難しくて何が簡単なのかが<span class="highlight">うまく理解できていない</span>';
$string['rubric[8]_score1'] = '相互評価の結果と自分の予測とのギャップを感じたが、次回の作問における出題内容の<span class="highlight">見直しや難易度の調整をすることはできそうにない</span>';
